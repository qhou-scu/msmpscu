  module MSM_TYPEDEF_RecordStamp
  !***  DESCRIPTION:
  ...
  !
   ...
   implicit none
      ...
      end type MSMRecordStamp

  contains

  !****************************************************************************************
  subroutine Default_RecordStamp(Stamp)
  !***  DESCRIPTION: to set default values for a MSMRecordStamp
  !
  implicit none
     !--- DUMMY variables
  ...
  !            Stamp, the record stamp
   ...
   implicit none
      !--- DUMMY variables
      integer,          intent(in) ::hFile
      type(MSMRecordStamp),intent(out)::Stamp
 ...
 100   close(hFile)
  ...
  implicit none
      !--- DUMMY variables
      integer, intent(in)          :: hFile
      type(MSMRecordStamp), intent(in):: Stamp
      !--- Local

         write(hFile) Stamp%AppTYpe(1:len(Stamp%AppTYpe))
         write(hFile) Stamp%ITest, Stamp%NBox, Stamp%IBox, Stamp%ICfg, Stamp%IRec, Stamp%ITime, Stamp%Time
  ...
  implicit none
      ...
      !--- Local
         ...
         read(hFile) Stamp%ITest, Stamp%NBox, Stamp%IBox, Stamp%ICfg, Stamp%IRec, Stamp%ITime, Stamp%Time

  end subroutine Restore_RecordStamp
  !****************************************************************************************

  !****************************************************************************************
  end module MSM_TYPEDEF_RecordStamp
  !****************************************************************************************
