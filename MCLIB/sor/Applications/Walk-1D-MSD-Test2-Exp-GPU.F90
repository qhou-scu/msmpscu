 ...
 !                   
 !                  This is a GPU version, in comparison with the CPU verision Walk-1D-MSD-Test2-Exp.F90.
 !
    ...
    !--- Device variable
     ...
     !*** to initialize the DEVICE
       ...
       do while(CURT .le. TTIME)
          ...
          call Stepto_RecTime_Exp_1D_Test(1, NB, Tau, DSTEP, CURT, dPreTime, dNextTime, dNJump, dXP)
