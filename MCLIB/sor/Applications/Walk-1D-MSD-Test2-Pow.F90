 ...
 !                   
 !                  This is a CPU version, in comparison with the GPU verision Walk-1D-MSD-Test2-Pow-GPU.F90.
 !
 ...
 program Walk_1D_MSD_Test2_Main
    ...
    real(KINDDF)::R, DT, TAU=1.D0, MSD, DSTEP=2., TSTEP=1.D0, TTIME=1000.D0, CURT, ATT, STIME, MT, MN, MT2, MN2, CURSTEP, POW=3.0
