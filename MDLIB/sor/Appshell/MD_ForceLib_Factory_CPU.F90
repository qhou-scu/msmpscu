  ...
  type(MDForceClassCPU), intent(inout) ::Forceclass
  ...
  end module MD_ForceLib_Factory_CPU
  !****************************************************************************************
