 ...
 !REFERENCE: F.Cleri and V.Rosato, Phys.Rev.B48, (1993) 22
  ...
  implicit none
       ...
       real(KINDDF),parameter,private::A= 0.2061D0*CP_EVERG
       real(KINDDF),parameter,private::ETA= 1.790D0*CP_EVERG
       real(KINDDF),parameter,private::P= 10.229D0
       real(KINDDF),parameter,private::Q= 4.036D0
       real(KINDDF),parameter,private::RIJ0= 4.079D0*CP_HALFRSQ2*CP_A2CM
