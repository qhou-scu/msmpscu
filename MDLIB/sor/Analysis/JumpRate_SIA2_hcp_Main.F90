 ...
 !                  The program is used to analyze the change and movement of SIA-cluster in hcp.
 ...
 contains
  ...
  !-------------
        ...
        !--- prepair for output
            ...
            write(hFile1,fmt="(A)")          "!                   = 2, for a conmbination jump; "
            ...
            write(hFile1,fmt="(A)")          "!     JUMP_DIR:     jumping direction defined by hcp index"
         ...
         !--- do bond analysis
             ...
             do while(.true.)  !--- loop for time steps
                ...
                do IB = m_CtrlParam%JOBID0, m_CtrlParam%JOBID1, m_CtrlParam%JOBIDSTEP
                   ...
                   call DefectBondInfo0_HCP(Clusters1(IB), BondInfo1, FLAG1)
                   call DefectBondInfo0_HCP(Clusters2(IB), BondInfo2, FLAG2)
                   call DefectBondInfo1_HCP(Clusters1(IB), BondInfo1P, FLAG1P)
                   call DefectBondInfo1_HCP(Clusters2(IB), BondInfo2P, FLAG2P)
 ...
 end module JumpRate_SIA2_hcp


 !**********************************************************************************
 Program JumpRate_SIA2_hcp_Main
 use JumpRate_SIA2_hcp
 implicit none
       ...
       stop
 End program JumpRate_SIA2_hcp_Main
