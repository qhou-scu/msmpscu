 ...
 !                  This program is used to calculate the centrosymmetry distribution in a FCC system
 !
 !**** ALGORITHM:
 !
 !
 ...
 !                       CentroSymParam_for_FCC_GPU.F90
 !
 !
 ...
 !**** HISTORY:
 !                  version 1st 2015-01, adapted from CentroSymParam_for_BCC_GPU_Main.F90  (Hou Qing, Sichuan university)
 !
 !

 Program CentroSymParam_for_FCC_MAIN
 use MD_SimBoxArray_ToolShell_14_GPU
 use CentroSymParam_for_FCC_GPU
 ...
 implicit none
       ...
       stop
 end   program CentroSymParam_for_FCC_MAIN
