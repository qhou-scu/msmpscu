 ...
 !                  The program is used to extract boxes from multibox configure. The difference between
 !                  this program and MultBox2Boxes is: this program dose not need to read SETUP file.
 !
 !                  REFERENCE____________________________________________________________________________
 !                       MultBox2Boxes_Main.F90
 !
 !**** USAGE:       _______________________________________________________________________________________
 !                  ExtractBox.exe -s "filename" -T(est) t1, t2, ts -C(fg) c1, c2, cs -B(ox) b1, b2, b3
 !                  where:
 ...
 !                        with the original filename appended by _BOXn
 !                  ______________________________________________________________________________________
 !**** HISTORY:
 !                  1st version   2018-01 (Hou Qing Sichuan university)
 !
 !
 ...
 implicit none
  ...
  !***  DESCRIPTION: to merge a set of files of different ITEST but the same ICFG
   ...
   !--- local variables for IO
         integer::ITEST, ICFG, hFile1, hFile2, hFileH, LINE, LINEH, LINEA, NA1, NA2, FLAG, N, I
         character*256::GFILE
...
100                close(hFile1)
 ...
 !**********************************************************************************
 end module ExtractBox
 !**********************************************************************************

 !**********************************************************************************
 Program ExtractBox_Main
 use ExtractBox
 implicit none
