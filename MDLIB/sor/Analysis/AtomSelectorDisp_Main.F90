 ...
 !                  The program is used to select out the atoms with displacement larger than
 ...
 module AtomSelectorDisp
  ...
  !**********************************************************************************
   ...
   use MD_TYPEDEF_SimMDBox
   use MD_TYPEDEF_SimMDCtrl
   use AtomSelectorCommon, only:Initialize_AtomSelectorCommon, SetSelectProc, m_INFILE
   implicit none
  !----   DUMMY Variables
  ...
  integer::I
         ...
         call Initialize_AtomSelectorCommon(SimBox, CtrlParam)
  ...
  !
  !
  use AtomSelectorCommon, only:Record_AtomSelectorCommon
  implicit none
  ...
  !   OUTPUT:
  !
   use AtomSelectorCommon, only:Clear_AtomSelectorCommon

   implicit none
       type(SimMDBox) ::SimBox
       type(SimMDCtrl)::CtrlParam

          call Clear_AtomSelectorCommon(SimBox, CtrlParam)
          return
  end subroutine MyCleaner
  !**********************************************************************************
 end module AtomSelectorDisp

 !***********************************************************************************
 Program AtomSelectorDisp_Main
 use MD_SimBoxArray_ToolShell_14_CPU
 use AtomSelectorDisp
